...
public abstract class CodeFileSaverTemplate<T> {
    ...
    protected CodeFileSaverTemplate(AICodeProperties properties) {
    ...
    protected void validateInput(T result) {
        BusinessAssert.notNull(result, ErrorCode.SYSTEM_ERROR, "代码结果对象不能为空");
    }
    ...
    protected final String buildUniqueDir() {
        ...
        String dirPath = outputDir + File.separator + uniqueName;
